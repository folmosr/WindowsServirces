...
namespace WSPlantilla
{
    public partial class ServicioMSMQ : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            try
            {
                configurador.LogWriter.Write(new LogEntry() { Message = String.Format("Datos de instancia Hilos:{0}, Tiempo de Ejecución:{1}", configurador.ThreadsQuantity, configurador.TimeInterval.ToString()), Categories = new List<string> { "eventLog" }, Priority = 1, ProcessName = "Leyendo Queue" });
